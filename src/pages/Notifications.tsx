import { AtSign, BellOff, Heart, Loader2, MessageCircle, UserPlus } from 'lucide-react'
...
const icons={like:Heart,comment:MessageCircle,follow:UserPlus,mention:AtSign,system:AtSign}
